function trackMousePosition() {
    ...
    heroElement.addEventListener('mousemove', (event) => {
        ...
        const normalizedX = (clientX / window.innerWidth) * 100;
        const normalizedY = (clientY / window.innerHeight) * 100;
        ...
        const parallaxOffsetX = (clientX - window.innerWidth / 2) / 50;
        const parallaxOffsetY = (clientY - window.innerHeight / 2) / 50;
